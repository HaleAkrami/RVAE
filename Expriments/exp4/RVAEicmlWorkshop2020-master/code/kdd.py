...
output_dir = "/big_disk/akrami/git_repos_new/RVAEicmlWorkshop2020/code/data/real/"
temp_dir = "tmp/"
...
def get_train_val_test(val_ratio=None, anom_frac=None):
    ...
    df_train = pd.read_csv("/big_disk/akrami/git_repos_new/RVAEicmlWorkshop2020/code/data/kdd/KDDTrain+.txt", dtype='str', header=None)
    df_test = pd.read_csv("/big_disk/akrami/git_repos_new/RVAEicmlWorkshop2020/code/data/kdd/KDDTest+.txt", dtype='str', header=None)
