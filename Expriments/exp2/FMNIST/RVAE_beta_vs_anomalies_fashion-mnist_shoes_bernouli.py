        ...
        for i, (data, data_lab) in enumerate(test_loader):
            ...
            if i == 0:
                ...
                save_image(comparison.cpu(),
                           'results/fashion-mnist_bernoulli_' + str(beta_val) +
                           '_' + str(frac_anom) + '.png',
                           nrow=n)

        np.savez('results/fashion-mnist_bernoulli_' + str(beta_val) + '_' +
                 str(frac_anom) + '.npz',
...
if __name__ == "__main__":
    ...
    for b, betaval in enumerate(brange):
        ...
        np.savez('test_loss_fashion_mnist_betas_fracanom.npz',
