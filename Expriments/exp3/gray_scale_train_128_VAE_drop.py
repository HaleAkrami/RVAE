...
if pret==1:
    load_model(399, G.encoder, G.decoder)
...
for epoch in range(max_epochs):
    ...
    show_and_save('rec_epoch2_%d.png' % epoch ,make_grid((rec_imgs2.data[:,2:3,:,:]).cpu(),8))
